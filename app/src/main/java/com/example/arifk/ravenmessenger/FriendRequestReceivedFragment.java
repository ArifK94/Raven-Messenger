...
public class FriendRequestReceivedFragment extends Fragment {
    ...
    public FriendRequestReceivedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userRef = db.collection("Users").document(firebaseAuth.getCurrentUser().getUid()).collection(KEY_COLLECTION_FRIEND_REQUESTS_RECIEVED);
    ...
    private void setupRecyclerView() {
        ...
        userAdapater.setmBackgroundResourceImage(R.drawable.colour_item_friend_received_bg);
